...
- **Reaper** — mutation testing. On new commits it runs mutation testing on the
  Builder's changed production code and sends the Builder a `mutation-review`, or a
...
- **Reaper** (`iterm_reaper.py`, every 900s) wakes on new commits and runs mutation
